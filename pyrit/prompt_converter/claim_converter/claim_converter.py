...
class ClaimConverter(PromptConverter):
    ...
    async def convert_async(self, *, prompt: str, input_type: PromptDataType = "text") -> ConverterResult:
        ...
        # inferences_selected = st.text_area(
        #     label=(
        #         "Claims generated by the framework using the heuristics you selected. "
        #         "Please edit as needed, but make sure there is only one claim per line. "
        #     ),
        #     value="\n".join(inferences), on_change=_reset_to_step(CURRENT_STEP),
        # )
        ...
        # for i, inf in enumerate(inferences_selected):
        #     result = run_pipeline_per_source(
        #         instance=inf,
        ...
        #         **sampling_kwargs,
        #     )
        #     generations.extend([(inf, out) for out, _ in result])
        ...
        def on_button_click(b):
            ...
            # with output_area:
            #     print("RETURN INSIDE----------------:" + str(len(self.response_msg)))
            return ConverterResult(output_text="INSIDE", output_type="text")
        ...
        # with output_area:
        #     print("RETURN OUTSIDE----------------: " + str(len(self.response_msg)))
