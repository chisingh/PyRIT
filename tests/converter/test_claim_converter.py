...
@patch(
    "pyrit.prompt_converter.claim_converter.classifiers.SetFitModelFromClassifier.from_pretrained",
...
async def test_convert_async(
    mock_from_pretrained, mock_load_few_shot_source, mock_run_pipeline_per_source, mock_input, mock_display
):
